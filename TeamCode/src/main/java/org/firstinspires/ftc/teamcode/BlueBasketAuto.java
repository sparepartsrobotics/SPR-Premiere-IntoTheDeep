        ...
        waitForStart();
            ...
            Actions.runBlocking(
                    drive.actionBuilder(initialPose)
                            ...
                            .waitSeconds(.8)
                            .strafeToLinearHeading(new Vector2d(54,54), Math.toRadians(-150))
                            .stopAndAdd(bmethods.linSlideHighBasket())
                            .waitSeconds(1.3)
                            .stopAndAdd(bmethods.releaseSample())
                            .waitSeconds(.4)
                            ...
                            .strafeToLinearHeading(new Vector2d(23, 0), Math.toRadians(180), new TranslationalVelConstraint(75))
                            .build()
            );
    }
}
