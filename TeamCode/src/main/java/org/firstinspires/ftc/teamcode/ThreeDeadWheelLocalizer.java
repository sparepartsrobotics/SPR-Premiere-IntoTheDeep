...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2359.800747219409; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2221.7224249903884; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -890.9110602684559; // x position of the perpendicular encoder (in tick units)
    }
