...
@Config
@Autonomous(name = "SpecimenRed", group = "Autonomous")
public class SpecimenRed extends LinearOpMode{
    ...
    public void runOpMode(){
        ...
        TrajectoryActionBuilder tab1 = drive.actionBuilder(initialPose)
                ...
                .lineToY(-50)
                .strafeToLinearHeading(new Vector2d(34,-30), Math.toRadians(70))
                .strafeToSplineHeading(new Vector2d(40,-49), Math.toRadians(-30))
                .stopAndAdd(smethods.specPuClose())
                .strafeToLinearHeading(new Vector2d(47, -30), Math.toRadians(80));
        TrajectoryActionBuilder tab1x = drive.actionBuilder(new Pose2d(47,-30, Math.toRadians(80)))
                .stopAndAdd(smethods.specPush())
                .strafeToSplineHeading(new Vector2d(48,-50), Math.toRadians(-30))
                .stopAndAdd(smethods.specPuClose())
                .strafeToLinearHeading(new Vector2d(55,-30), Math.toRadians(80))
                .stopAndAdd(smethods.specPush())
                .strafeToSplineHeading(new Vector2d(55,-49), Math.toRadians(-30))
                .stopAndAdd(smethods.specPuClose())
                .stopAndAdd(smethods.pickupSpecimen())
                .strafeToLinearHeading(new Vector2d(35,-49), Math.toRadians(90))
                .strafeTo(new Vector2d(35,-58));
        TrajectoryActionBuilder tab2 = drive.actionBuilder(new Pose2d(35,-58, Math.toRadians(90)))
        ...
        TrajectoryActionBuilder tab3 = drive.actionBuilder(new Pose2d(-3,-48, Math.toRadians(90)))
                .stopAndAdd(smethods.pickupSpecimen())
                .strafeTo(new Vector2d(35,-45))
                .strafeTo(new Vector2d(35,-56.5))
                .stopAndAdd(smethods.closeClaw())
