        ...
        waitForStart();
            ...
            Actions.runBlocking(
                    drive.actionBuilder(initialPose)
                            ...
                            .strafeToLinearHeading(new Vector2d(-54.5, -54.5), Math.toRadians(40))
                            ...
                            .waitSeconds(.8)
                            .strafeToLinearHeading(new Vector2d(-54,-54), Math.toRadians(40))
                            .stopAndAdd(bmethods.linSlideHighBasket())
                            .waitSeconds(1.3)
                            .stopAndAdd(bmethods.releaseSample())
                            .waitSeconds(.4)
                            ...
                            .stopAndAdd(bmethods.bringClawArmDown())
                            .waitSeconds(.8)
                            .strafeToLinearHeading(new Vector2d(-55, -55), Math.toRadians(40))
                            .stopAndAdd(bmethods.linSlideHighBasket())
                            .waitSeconds(1.3)
                            .stopAndAdd(bmethods.releaseSample())
                            .waitSeconds(.4)
                            .stopAndAdd(bmethods.resetLinSlide())
                            .strafeToLinearHeading(new Vector2d(-56.5,-26.5), Math.toRadians(180))
                            ...
                            .strafeToLinearHeading(new Vector2d(-23, -15), Math.toRadians(0), new TranslationalVelConstraint(70))
                            .build()
            );
    }
}
